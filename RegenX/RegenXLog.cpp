...
namespace regenx::log {
    bool init() {
        if (!regenx::file::create(LOG_PATH)) {
    ...
    void info(const std::string& msg) {
        if (regenx::file::exist(LOG_PATH) && !regenx::file::write(LOG_PATH, "[INFO] " + msg)) {
    ...
    void debug(const std::string& msg) {
        if (regenx::file::exist(LOG_PATH) && !regenx::file::write(LOG_PATH, "[DEBUG] " + msg)) {
    ...
    void trace(const std::string& msg) {
        if (regenx::file::exist(LOG_PATH) && !regenx::file::write(LOG_PATH, "[TRACE] " + msg)) {
    ...
    void warning(const std::string& msg) {
        if (regenx::file::exist(LOG_PATH) && !regenx::file::write(LOG_PATH, "[WARNING] " + msg)) {
    ...
    void error(const std::string& msg) {
        if (regenx::file::exist(LOG_PATH) && !regenx::file::write(LOG_PATH, "[ERROR] " + msg)) {
    ...
    void fatal(const std::string& msg) {
        if (regenx::file::exist(LOG_PATH) && !regenx::file::write(LOG_PATH, "[FATAL] " + msg)) {
    ...
    void system(const std::string& msg) {
        if (regenx::file::exist(LOG_PATH) && !regenx::file::write(LOG_PATH, "[SYSTEM] " + msg)) {
